    ...
    content: (
      <div className="space-y-6">
        <p className="text-gray-700 text-base md:text-lg leading-relaxed">
          ...
          travail en équipe. Cette opportunité t'es adressée. <span className="text-red-700 font-semibold">Le Réseau des Bénévoles APESSA (RBA)</span>  t'ouvre ses
          portes. Rejoins nous dès à présent pour une expérience associative pleine d'engouement en
          remplissant ce formulaire jusqu'au 23 juillet 2021.
        </p>
        
        <button className="text-white py-2 px-4 font-medium rounded-3xl bg-red-700" type="button">
  ...
  "resource-2": {
    ...
    content: (
      <div className="space-y-6">
        ...
        Dans le cadre de la campagne <span className="text-red-700 font-semibold">« Exprime toi »</span>, le Réseau des Bénévoles de l’APESSA Bénin, <span className="text-red-700 font-semibold">#RBA</span>{" "}
        organise en collaboration avec l’ambassade du royaume des Pays-Bas,
         une conférence débat sur le
        thème : Jeunesse, Emploi et Développement
        ? Vendredi 19 septembre 2019 à partir de 16h00.
        ?Retransmission en direct sur la page facebook <span className="text-red-700 font-semibold">@APESSABENIN</span>?
        Soyez connecté et n’hésitez pas à intervenir !{" "}
             <span className="text-red-700 font-semibold">#TogetherWeSpeak</span>        
        </p>
    ...
    content: (
      <div className="space-y-6">
        ...
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">
          ...
          <div className="grid gap-2.5 md:text-lg text-base text-gray-700">
          ...
          <div className="grid gap-2">
        <h1 className="text-red-700 text-lg underline md:text-2xl font-bold">Ta candidature à ce recrutement nous intéresse !</h1>
        ...
        <p className="text-gray-700 md:text-lg text-base leading-relaxed">
          <span className="text-red-700 font-bold">Le Réseau des Bénévoles de Abomey-Calavi</span>, sous-structure de l’APESSA créé en 2019 mène des
        ...
        <div className="grid gap-2">
        <h1 className="text-red-700 text-lg md:text-2xl underline font-bold">Description du rôle du bénévole</h1>
        
        <p className="text-gray-700 md:text-lg text-base leading-relaxed">La responsabilité du bénévole consiste à encadrer, en toute sécurité, les élèves/étudiants et toutes
        ...
        <div className="grid gap-2">
        <h4 className="text-red-700 font-bold text-lg md:text-2xl underline">Tâches</h4>
        ...
        <div className="grid gap-2">
          <h4 className="text-red-700 text-lg md:text-2xl underline font-bold">Profil souhaité</h4>
  ...
  "resource-5": {
    ...
    content: (
      <div className="space-y-6">
        ...
        <div className="gap-2 grid">
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">Tu as la vocation et la volonté d'un ou plusieurs des points ci-après :</p>
        ...
        <div className="grid gap-2">
        <h1 className="text-red-700 text-lg md:text-2xl underline font-bold">Ta candidature à ce recrutement nous intéresse !</h1>
        ...
        <div className="grid gap-2">
        <h1 className="text-red-700 text-lg md:text-2xl underline font-bold">Tâches</h1>
        ...
        <div className="grid gap-2">
          <h1 className="text-red-700 text-lg md:text-2xl underline font-bold">Profil souhaité</h1>
        ...
        <div className="grid gap-2">
          <h1 className="text-red-700 text-lg md:text-2xl underline font-bold">Composition du dossier de candidature</h1>
          <div className="md:text-lg text-base text-gray-700 leading-relaxed">
        ...
        <div className="grid gap-2">
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">Envoyez également vos candidatures par EMAIL: <span className="text-red-700 font-bold">rbaparakou@apessa.net</span> </p>
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">Appel ou WhatsApp:  <span className="text-red-700 font-bold">01 66 87 26 14</span> </p>
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">Site web : <Link href='http://www.apessa.net/'><span className="text-red-700 font-bold">www.apessa.net</span></Link></p>
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">Facebook: <span className="text-red-700 font-bold">APESSABENIN</span></p>
      </div>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-6">
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">
        A {" "}l’occasion de la Journée internationale pour l’élimination de la violence à l’égard des femmes, le Réseau
        ...
        hashtag <span className="text-red-700 font-semibold">#EcoutezMoiAussi</span>, <span className="font-semibold text-red-700">#MESGestesComptent</span>, <span className="text-red-700 font-semibold"> #16joursdactivisme</span> <span className="text-red-700 font-semibold">#Orangerlemonde229.</span>
        </p>
                
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">
          Pour ne rien rater, rejoignez la page officielle de l’évènement sur facebook à l’adresse {" "}
           <Link href='https://www.facebook.com/events/995224264144467'><span className="text-red-700">https://www.facebook.com/events<br className="block md:hidden"/>/995224264144467</span></Link>
        </p>
        ...
        <p className="md:text-lg text-base text-gray-700 leading-relaxed">
          ...
          <button className="text-white py-2 px-4 font-medium text-sm md:text-base rounded-3xl bg-red-700" type="button">
...
export default async function ResourcePage({ params }: ResourcePageProps) {
  ...
  return (
    <div className="w-full bg-red-50">
    <article className="max-w-6xl mx-auto md:p-6 py-12 px-6 bg-red-50">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          <h1 className="md:text-4xl text-xl underline font-bold mb-4 text-red-700">{resource.title}</h1>
